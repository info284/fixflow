...
export async function GET(req: Request) {
  try {
    ...
    const { data: prof, error: pErr } = await admin
      .from("profiles")
      .select("display_name, business_name, logo_url, vat_number, brand_colour, business_phone, notify_email, trading_address")
      .eq("id", uid)
      .maybeSingle();
...
amount: inv.amount,
amount_before_deposit: inv.amount_before_deposit,
deposit_paid_amount: inv.deposit_paid_amount,
