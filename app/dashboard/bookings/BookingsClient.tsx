                      ...
                      >
                        <div className="ff-leftItemInner">
                          ...
                          <div className="ff-leftCustomer">
                            {titleCase(
                              q.customer_name || request?.customer_name || "Customer"
                            )}
                          </div>
