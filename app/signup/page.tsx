     ...
     <div className="relative mx-auto max-w-md px-4 py-14">
       <div className="mb-6 flex items-center justify-center gap-3">
         ...
         <div className="text-left">
           ...
           <div className="text-[16px] font-extrabold text-slate-950">Trader signup</div>
         </div>
       </div>
       ...
       <div className="relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white/95 backdrop-blur shadow-[0_2px_0_rgba(15,23,42,0.04),0_20px_45px_rgba(15,23,42,0.12)]">
         ...
         <form onSubmit={handleSignup} className="relative p-5">
           ...
           <div className="mt-4">
             <label className="mb-1 block text-[13.5px] font-semibold text-slate-700">Business name</label>
             <input
               value={businessName}
       ...
       <div className="mt-6 text-center text-[13px] text-slate-500">
         ...
         <a className="font-semibold hover:text-slate-700" href="/terms">terms</a>{" "}
         and{" "}
         <a className="font-semibold hover:text-slate-700" href="/privacy">privacy policy</a>
